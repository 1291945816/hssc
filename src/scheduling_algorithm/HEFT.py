...
class HEFT:
    def __init__(self, input_list=None, verbose=False, p=3, b=0.5, ccr=0.5):
        if len(input_list) == 4:
...
if __name__ == "__main__":
    ProcessDag.get_input_list("E:\\heterogeneous_simu_code\\data_gen\\V_20_Alpha_0.5_Maxout_4_CCR_0.1_Beta_0.25\\0.txt")
